  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="clothesApp.category.home.createOrEditLabel" data-cy="CategoryCreateUpdateHeading">
            <Translate contentKey="clothesApp.category.home.createOrEditLabel">Create or edit a Category</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('clothesApp.category.name')}
                id="category-name"
                name="name"
                data-cy="name"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('clothesApp.category.description')}
              ...
              />
              <ValidatedField
                label={translate('clothesApp.category.createdDate')}
              ...
              />
              <ValidatedField
                label={translate('clothesApp.category.lastModifiedDate')}
              ...
              />
              <ValidatedField
                label={translate('clothesApp.category.createdBy')}
              ...
              />
              <ValidatedField
                label={translate('clothesApp.category.lastModifiedBy')}
