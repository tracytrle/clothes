...
To build the final jar and optimize the clothes application for production, run:
...
Then navigate to [http://localhost:8998](http://localhost:8998) in your browser.
